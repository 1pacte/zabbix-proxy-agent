...
ENV TERM=xterm ZBX_VERSION=${ZBX_VERSION} ZBX_SOURCES=https://git.zabbix.com/scm/zbx/zabbix.git MIBDIRS=/var/lib/mibs/ietf:/var/lib/mibs/iana:/usr/share/snmp/mibs:/var/lib/zabbix/mibs MIBS=+ALL ZBX_TLSPSKFILE=/etc/zabbix/zabbix_proxy.psk ZBX_TLSPSKIDENTITY=proxy1 ZBX_TLSCONNECT=psk ZBX_ENABLEREMOTECOMMANDS=1 ZBX_SERVER_HOST=90.85.33.105 ZBX_HOSTNAME=XXX-XXX-ZPROXY ZBX_PROXYOFFLINEBUFFER=96 ZBX_PROXYHEARTBEATFREQUENCY=900 ZBX_CONFIGFREQUENCY=7200 ZBX_DATASENDERFREQUENCY=900 ZBX_IPMIPOLLERS=3 ZBX_STARTVMWARECOLLECTORS=3 ZBX_VMWAREFREQUENCY=3600 ZBX_VMWAREPERFFREQUENCY=3600 ZBX_VMWARECACHESIZE=16M ZBX_CACHESIZE=16M
